...
describe("Assignment 1 Part 2", () => {
  describe("countLetters", () => {
    ...
    it("counts letters", () => {
      expect(countLetters("I am robot")).toEqual({
        i: 1,
        a: 1,
        m: 1,
        r: 1,
    ...
    it("counts letters", () => {
      expect(countLetters("abcABCaabbcc d")).toEqual({
        a: 4,
        b: 4,
        c: 4,
        d: 1,
  ...
  describe("treeToSentence", () => {
    ...
    it("Represents a tree as a sentence", () => {
      const t3: WordTree = {
        root: "hello",
        children: [{ root: "there", children: [{ root: "!", children: [] }] }],
      };
